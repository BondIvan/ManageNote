...
class ReplaceTest implements TestCommands {
    ...
    @Test
    void testReplaceServiceLogin_withAccounts() throws UnknownArgsException, AccessNotFoundException {
    ...
    @Test
    void testReplaceServicePassword_withAccounts() throws UnknownArgsException, AccessNotFoundException {
    ...
    public void testForExceptions() {
        ...
        NoteEntity note3 = new NoteEntity("Vk.com (2-nd account)", "second.account@gmail.com");
        notes.add(note1); notes.add(note2); notes.add(note3);
        try {
            note1.setPassword("password_vk_1");
            note2.setPassword("password_telegram_2");
            note3.setPassword("password_vk_2");
        } catch (UnknownArgsException e) {
            System.err.println(e.getMessage());
        }

        Exception accessNotFoundException1 = assertThrows(AccessNotFoundException.class, () -> replace.perform("arg1_name service arg3_newString"));
        Exception accessNotFoundException2 = assertThrows(AccessNotFoundException.class, () -> replace.perform("vk.com wrongLogin service arg3_newString"));
        Exception unknownArgsException1 = assertThrows(UnknownArgsException.class, () -> replace.perform("arg1_name arg2_typeAndLess"));
        Exception unknownArgsException2 = assertThrows(UnknownArgsException.class, () -> replace.perform("arg1_name args2_login args3_type arg4_newString andMore"));
        ...
        Exception unknownArgsException4 = assertThrows(UnknownArgsException.class, () -> replace.perform("Vk.com args_login arg2_wrongType arg3_newString"));
        Exception incorrectValueException1 = assertThrows(IncorrectValueException.class, () -> replace.perform("Vk.com second.account@gmail.com login first.account@gmail.com"));
        ...
        Assertions.assertEquals("Неизвестный параметр", unknownArgsException4.getMessage());
